...
function getFlavorByIndex(originalFlavors) {
  const extracted = originalFlavors.slice(2, 3);
...
let originalFlavors2 = [];

function copy(originalFlavors, originalFlavors2) {
  originalFlavors2 = [...originalFlavors];

  return originalFlavors2;
}
copyOfArray = copy(originalFlavors, originalFlavors2);

console.log(originalFlavors2);
